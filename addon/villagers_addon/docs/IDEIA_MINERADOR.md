...
**Pasta:** `addon/villagers_addon/`  
**Referencia de padroes:** `addon/villager_soldiers/` (Villager Soldiers 3.1.4) — ver `AGENTS.md` la.  
...
- `addon/villager_soldiers/AGENTS.md` — mapa do pack de referencia
- `addon/villager_soldiers/behavior_pack/entities/worker/villager_free_handle.json` — hire por ferramenta
- `addon/villager_soldiers/behavior_pack/entities/worker/villager_clumper.json` — worker de “mineraçao” falsa
- `addon/villager_soldiers/behavior_pack/scripts/function/makingProduction.js` — refine inventory
