...
**Referencia de padroes:** `addon/villager_soldiers/` (hire/stay/banner UX) + minerador `va:villager_miner` (origem, banner, deposito).  
**Namespace:** `va:`  
...
1. IDs so `va:*` novos.
2. Nao editar `addon/villager_soldiers/**`.
...
- `addon/villager_soldiers/AGENTS.md`
