...
const TYPE_BOW = "percussion_cap_musket:bow";
const TYPE_EMPTY = "fv:percussion_cap_musket_empty";
const TYPE_BULLET_ITEM = "fv:bullet";
const TYPE_BULLET_ENTITY = "fv:entity_bullet";

const COOLDOWN_CAT = "percussion_cap_musket_empty";
...
// FIX LỖI 1A: Xử lý trừ đạn an toàn
...
world.afterEvents.itemUse.subscribe(async ev => {
    ...
    // FIX LỖI 2: Kiểm tra cooldown để chặn nạp chồng
    ...
    player.playAnimation("animation.nguoimau.reload_percussion_cap_musket", {
        blendOutTime: 0.3,
        stopExpression: "!query.equipped_item_any_tag('slot.weapon.mainhand', 'fv:percussion_cap_musket_empty')"
    });
