...
**Caminho:** `addon/villager_soldiers/`  
...
Este documento descreve como o addon funciona, quais recursos implementa e quais padroes reutilizar ao construir um addon semelhante (ex.: soldados contrataveis a partir de villagers; complemento em `addon/villagers_addon/`).
...
```powershell
# Na pasta addon/villager_soldiers
